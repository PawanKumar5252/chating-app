...
public class Watapp extends JFrame {
    ...
    Watapp() {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("watapp/icon/1" + ".png")); //profile video Icon.
       ...
       // }
//        else{
//           ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource(spy)); //profile video Icon.
//        Image i2 = i1.getImage().getScaledInstance(30, 30, Image.SCALE_DEFAULT);
//        ImageIcon i3 = new ImageIcon(i2);
//        l1 = new JLabel(i3);
//        l1.setBounds(5, 5, 30, 30);
...
//        add(a2);
    ...
    public static void main(String[] args) {
        ...
        try {
            ServerSocket se = new ServerSocket(234);
            ss = se.accept();
...
//            bos=new BufferedOutputStream(os);
            ...
            while (msg != null) {
                ...
                f1dec.setText(f1dec.getText() + "" + msg);
            }
            // ss.close();
            //ss.close();
